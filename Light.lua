...
Closed.Image = "rbxassetid://17263246688"
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://17263246688"
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("Vũ Lỏ Hub",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Tab Chính","1")
local Sea = SOMEXHUB:AddTab("Tab Sự Kiện Biển","1")
local M = SOMEXHUB:AddTab("Tab Vật Phẩm","1")
local Ss = SOMEXHUB:AddTab("Tab Chỉ Số","1")
local RaceV4 = SOMEXHUB:AddTab("Tab Tộc V4","1")
local P = SOMEXHUB:AddTab("Tab Người chơi","1")
local R = SOMEXHUB:AddTab("Tab Tập Kích","1")
local T = SOMEXHUB:AddTab("Tab Chuyển","1")
local S = SOMEXHUB:AddTab("Tab Cửa Hàng","1")
local D = SOMEXHUB:AddTab("Tab Trái Ác Quỷ","1")
local Misc = SOMEXHUB:AddTab("Tab Khác","1")
---------------------------------------------------------------------------
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
...
spawn(function()
    ...
    Main:AddToggle("Triệu Hồi Katakuri",false,function(value)
...
M:AddDropdown("Chọn Chế Độ", ListB,function(value)
    ...
    local BoneFarm = Main:AddToggle("Tự Động Cày Bone",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    Main:AddToggle("Tự Động Random Bone",_G.Auto_Random_Bone,function(value)
    ...
    Main:AddToggle("Tự Động Pray",pry,function(value)
    _G.Pray = value
    end)
    ...
    Main:AddToggle("Tự Động Try Luck",Trylux,function(value)
    _G.Trylux = value
    end)
...
spawn(function()
    ...
    D:AddToggle("Lụm Trái",_G.Tweenfruit,function(value)
    _G.Tweenfruit = value
